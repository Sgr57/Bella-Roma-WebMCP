...
export const TOP_PROMPTS: SuggestedPrompt[] = [
  ...
  { id: "S2", text: "Vorrei un cappuccino e qualcosa di dolce da abbinarci, ma non pesante" },
  ...
  { id: "S8", text: "Cosa va bene con quello che ho già nel carrello?", requires_cart: true },
];
